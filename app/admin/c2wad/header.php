    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="apikey.php">
              <i class="fa  fa-plus"></i> API Keys</a>
          </li>
          <li><a href="gasfee.php">
              <i class="fa  fa-plus"></i> Gas Fee</a>
          </li>
          ...
          <li class="treeview">
            <a href="#">
              ...
              <span>NFTs Management</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-down pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href="all_nft.php"><i class="fa fa-archive"></i> All NFTs</a></li>
              <li><a href="marketplace.php"><i class="fa fa-archive"></i> Marketplace NFTs</a></li>

              <li><a href="sold_nft.php"><i class="fa fa-archive"></i> SOLD NFTs</a></li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="all_lands.php"><i class="fa fa-archive"></i> All Lands</a></li>
              <li><a href="marketplace_land.php"><i class="fa fa-archive"></i> Marketplace Lands</a></li>

              <li><a href="sold_land.php"><i class="fa fa-archive"></i> SOLD Lands</a></li>

              <li><a href="pending_land.php"><i class="fa fa-archive"></i> Pending Lands</a></li>
