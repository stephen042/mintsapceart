...
if (isset($_POST['upload'])) {
   ...
   if (empty($_POST["nft_name"])) {
      $msg = "NFT Collection is required";
   } else {
   ...
   if (empty($msg)) {
      ...
      if (mysqli_query($link, $sqlu11)) {
                                                         ...
                                                         <tbody>
                                                            ...
                                                            <tr>
                                                               <td style="color:rgb(193,205,220);font-family:Muli,Arial,sans-serif;font-size:20px;line-height:30px;padding-bottom:25px">
                                                                  <div>You have successfully created a new NFT<b> .<br></b></div>
                                                                  <div><b><br></b></div>
         ...
         echo "<script>
                    alert('Your NFT Collection " . $nft_name . " has been created successfully, the Ref No. is " . $ref . ". It will be available on the marketplace once it is approved.');
                    
                    </script> ";
         $msgme = "Your NFT Collection " . $nft_name . " has been created successfully, the Ref No. is " . $ref . ". It will be available on the marketplace once it is approved.";
      }
   }
}
...
<div class="main-content-inner mt-4">
         ...
         <div class="alert alert-primary bg-dark">
               <div class="col-12">
                  <p class="text-white"><b>
                     PLEASE NOTE GAS FEE MUST BE PAID <i style="font-size:20px;" class="fa fa-free-code-camp mx-3" aria-hidden="true"></i>
                  </b></p>
               </div>
         </div>
      </div>
   ...
   <div class="row">
      <div class="col-lg-12">
         <div class="card">
            <div class="card-body">
               <h4 class="header-title"><i class="fa fa-money"></i>Create New NFT</h4>
               <form method="POST" enctype="multipart/form-data" action="create_nft.php">
                ...
                " . $msgme . "
                  ...
                  <div class="form-group">
                     <label for="acct_name">Collection Name</label>
                  ...
                  <div class="form-group">
                     <label for="acct_swift">Select NFT</label>
            ...
            <div class="col-12 mb-3">
               <div class="card">
                  <div class="card-body">
                     ...
                     <h3 class="card-title" style="color:black">My NFTs Collections</h3>
                     <div class="table-responsive">
                        <table class="table table-hover">
                           ...
                           <tbody>
                              ...
                              <?php
                              $i = 1;
                              $sql = "SELECT * FROM market WHERE email='$email' ORDER BY id DESC ";
