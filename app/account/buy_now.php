...
if(isset($_POST['buy'])){
    if (empty($_POST["unft_id"])) {
      ...
      if ($nftbuyusd <= $ubalance) {
        ...
        $msg= "Sorry! You Have Insufficient Fund! Please Deposit More Funds To Buy This NFT";
    }
    ...
    if(empty($msg)){
        ...
        $sqlu112 = "UPDATE market SET mstatus = 'SOLD', buyer = '$email' WHERE id = '$unft_id'";
                ...
                $sqlu11 = "INSERT INTO market (name, email, ref, logo, amount, status, mstatus, buystatus) VALUES ('$nftbuyname', '$email', '$ref', '$nftbuylogo', '$nftbuyusd', 'approved', 'BOUGHT', 'BOUGHT') ";
        ...
        $mail->FromName = $name;
         ...
         $mail->Subject = "New NFT Purchased";
         $mail->isHTML(true);
         $mail->Body = '
                                                         ...
                                                         <tbody>
                                                            ...
                                                            <tr>
                                                               <td style="color:rgb(193,205,220);font-family:Muli,Arial,sans-serif;font-size:20px;line-height:30px;padding-bottom:25px">
                                                                  <div>You have successfully purchased a new NFT<b> .<br></b></div>
                                                                  <div><b><br></b></div>
                                                                  <div><b>Details of your Purchase :<br></b></div>
                                                                  <div><br></div>
                                                                  <div>Amount : '.$nftbuyusd.' ETH</div>
                                                                  <div>NFT Name: '.$nftbuyname.'</div>
         ...
         if($mail->send()){
                      ...
                      echo "<script>
                    alert('You have successfully purchased NFT ".$nftbuyname." for ".$nftbuyusd." ETH, the Ref No. is ".$ref.".');
                    
                    </script> ";
                    $msgme = "You have successfully purchased NFT ".$nftbuyname." for ".$nftbuyusd." ETH, the Ref No. is ".$ref.".";
...
<div class="card">
<div class="card-body">
<h4 class="header-title"><i class="fa fa-money"></i>BUY NFT NOW</h4>
              ...
              ?>
                        ...
                        <label for="btc_address">NFT SELECTED</label>
